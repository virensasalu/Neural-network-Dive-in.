...
import nrecurrent_convolutional_networks_nn
...
def is_recurrent(layer: tensorflow.keras.layers.Layer):
    # return isinstance(layer, tensorflow.keras.layers.RNN)  # no longer sufficient in TensorFlow
    return (isinstance(layer, tensorflow.keras.layers.RNN) or
            isinstance(layer, tensorflow.keras.layers.Bidirectional) or
            isinstance(layer, tensorflow.keras.layers.LSTM) or
            isinstance(layer, tensorflow.keras.layers.GRU))
